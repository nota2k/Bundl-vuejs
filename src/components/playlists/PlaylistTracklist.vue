        ...
        <thead class="">
          <tr>
            <th class="">
              <span>Titre</span>
              <button class="filter">
                <svg id="Calque_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.46 41.89">
